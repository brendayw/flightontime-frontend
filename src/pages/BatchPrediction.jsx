...
import BatchPredicionFile from '../components/batch-prediction/BatchPredictionFile';
...
const BatchPrediction = ({ variant = "default" }) => {
    ...
    return (
        <section id='batch' className='min-w-screen min-h-screen bg-[#FEFFFA]'
            style={{
                width: '100vw',
            ...
            <main className='relative mx-auto mt-2'
                style={{
                    display: 'flex',
